...
@Component({
  selector: 'app-ad-updateprefac',
  templateUrl: './ad-updateprefac.component.html',
  styleUrls: ['./ad-updateprefac.component.css']
})
export class AdUpdateprefacComponent implements OnInit {
  image: any;
  Image = [];
  imageData: any;

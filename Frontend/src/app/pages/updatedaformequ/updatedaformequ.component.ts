...
@Component({
  selector: 'app-updatedaformequ',
  templateUrl: './updatedaformequ.component.html',
  styleUrls: ['./updatedaformequ.component.css'],
})
export class UpdatedaformequComponent implements OnInit {
  image: any;
  Image = [];
  imageData: any;

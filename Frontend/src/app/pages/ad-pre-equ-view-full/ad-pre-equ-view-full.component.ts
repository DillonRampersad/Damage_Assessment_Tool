...
@Component({
  selector: 'app-ad-pre-equ-view-full',
  templateUrl: './ad-pre-equ-view-full.component.html',
  styleUrls: ['./ad-pre-equ-view-full.component.css']
})
export class AdPreEquViewFullComponent implements OnInit {
  preequipm: PreEqu[] = [];

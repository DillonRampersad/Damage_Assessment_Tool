...
@Component({
  selector: 'app-ad-updatepreequ',
  templateUrl: './ad-updatepreequ.component.html',
  styleUrls: ['./ad-updatepreequ.component.css']
})
export class AdUpdatepreequComponent implements OnInit {
  image: any;
  Image = [];
  imageData: any;

...
@Component({
  selector: 'app-ad-daform-fac-view',
  templateUrl: './ad-daform-fac-view.component.html',
  styleUrls: ['./ad-daform-fac-view.component.css']
})
export class AdDaformFacViewComponent implements OnInit {

...
@Component({
  selector: 'app-ad-updatedaformfac',
  templateUrl: './ad-updatedaformfac.component.html',
  styleUrls: ['./ad-updatedaformfac.component.css']
})
export class AdUpdatedaformfacComponent implements OnInit {
  image: any;
  Image = [];
  imageData: any;
  ...
  updateDAFacForm() {
    ...
    this.router.navigate(['/ad-daform-fac-view']);
  }

...
@Component({
  selector: 'app-ad-update-moc',
  templateUrl: './ad-update-moc.component.html',
  styleUrls: ['./ad-update-moc.component.css']
})
export class AdUpdateMocComponent implements OnInit {
